...
\begin{document}
	...
	\noindent\rule[0.5ex]{\linewidth}{1pt}
		...
		\noindent {M.M. Nasiri, \textbf{M.R. Daneshvar Garmroodi} and M. Tembely. Experimental study on elasto-capillary dynamics of a viscoelastic hallow droplet,\textit{ Under Preparation}}.
	...
	\noindent \textbf {\small Accepted in the First Stage of the National Computer and Mathematical Olympiads.} \hfill {Fall 2010, 2011, 2012} 
		...
		{\noindent $\bullet$ Numerical simulation of the impact of a hallow viscoelastic droplet on a wetting surface using Basilisk. 
		...
		{\noindent $\bullet$ Adding dynamic mesh and tracking passive particles in the twoLiquidMixingFoam solver in OpenFOAM
	    \\ \textit{During PhD Program} 
	
	\vspace{0.5mm}
	
	{\noindent $\bullet$ Developing a melting solver in OpenFOAM Based on phase field and enthalpy methods
	\\ \textit{During PhD Program} 
		
		\vspace{0.5mm}
		
		{\noindent $\bullet$ Coding annular flow of a Newtonian fluid by finite volume SIMPLE method in MATLAB  
			\\ \textit{Advance Computational Fluid Mechanics Course}
			
	\vspace{0.5mm}
	
	{\noindent $\bullet$ Coding mixed convection in a lid-driven cavity using streamfunction-vorticity by finite difference method
		\\ \textit{Advance Computational Fluid Mechanics Course}
		
		\vspace{0.5mm}
		
		{\noindent $\bullet$ A priory and ”A Posteriori” tests using dynamic Smagorinsky, and Wong LES Models one the filtered Burgers’ equation by finite Difference Method
